...
8. Execute the `post-commit` skill (CHANGELOG + version bump only — no tag here; tagging is handled post-merge by `/fusengine:commit`'s Step 7/8, not by this quick command)
