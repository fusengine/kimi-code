...
Including Cursor, the Prisma CLI can also detect when it is being invoked by other popular AI coding agents such as Kimi Code, Gemini CLI, Qwen Code, Aider, and Replit.
